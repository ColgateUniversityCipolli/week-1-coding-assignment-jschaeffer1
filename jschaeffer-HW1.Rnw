...
<<CollatzPlot3>>
@
\caption{A canvas collatz using a gray background, odd angle=-0.05, n=72}
\label{CollatzPlot3}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
<<FlamePlot1, eval=FALSE, size="scriptsize", warning=FALSE, message=FALSE>>=
set.seed(15)
...
<<FlamePlot1>>
@
\caption{A canvas flame plot with a set seed of 15}
\label{CollatzPlot3}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
result.index = which(solution.vec == 40)
result.index
@
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  % QUESTION 2d
